...
//**Import de las entidades creadas**
import entity.Cargo;
import entity.Rol;
...
public class PersistenceApp {
	...
	public static void main(String[] args) {
		...
		// Se trabaja con entityManager Factory para poder persistir los datos de la aplicacion creada
		// Ademas aqui se realiza la conexion con la unidad de persistencia creada en el formato Xml
		...
		try {
			...
			// Acontinuacion lo que se realiza en la inyeccion de elementos entity en la base de datos creada
			...
			// En las entidades se tuvo en cuenta el uso de un HashSet para que los valores a ingresar no sean duplicados y ademas HashSet implementa la interfaz utilizada Set.
			// HashSet al tener acceso directo al un elemento este acceso hacer que esta clase sea la ideal para inserccion, busqueda y borrado de un elemento en base a una clave o llave
			Set<Rol> roles = new HashSet<Rol>();
			// En esta parte lo que se realiza en mediante add es agregar los datos anteriormente estructurados
			roles.add(rolesOne);
			roles.add(rolesTwo);
			...
			// En este caso como Usuario y Cargo son las entidades propietarias del lado ManyToMany seran las clases las cuales se persisten
